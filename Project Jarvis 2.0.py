...
playsound('D:\jarvis\jarvisvoice.mp3')

#os.startfile("D:\jarvis")
#playsound.playsound("jarvisvoice")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            # music_dir
            music_dir = "E:\\Bhanu Iphone\\Music"
            songs = os.listdir(music_dir)
            print(songs)
            ...
            speak("I have been created by python, under gidence of Professor Bhanu Prakash sir.")
            ...
            speak("Thanks to Bhanu Prakash. further It's a secret")
            ...
            speak("I am your virtual assistant created by Bhanu Prakash")
            ...
            speak(
                "connecting to the satelite and sending information to the server securing connection.here you are sir")
        ...
        # most asked question from google Assistant
            ...
            speak("member of group number 49 are", "sir Aditya", "sir Rahul", "sir Tarun", "sir Srikanth")

        elif "who is the head of group number 49" in query:
            speak("head of group 49 is Professor Bhanu Prakash sir")

        elif "Jarvis tell us about yourself" in query:
            speak(
                "OK i am jarvis 2.o created by members of group number 49 under gidence of professor Bhanu Prakash sir.i am virtual assistant.who can help you in your day today life.i can do virtually whatever you want.such as webbrowsing,opning applications,writing short notes.i can be your 24 7 assistant to help you sir.")
